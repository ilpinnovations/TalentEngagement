...
public class HealthSafetyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Health & Safety in UK");
        }
    ...
    public void insurance(View view) {
        Intent i = new Intent(this, InsuranceActivity.class);
        startActivity(i);
    }

    public void medical(View view) {
        Intent i = new Intent(this, MedicalActivity.class);
        startActivity(i);
    }

    public void mayfair(View view) {
        Intent i = new Intent(this, NHSActivity.class);
        startActivity(i);
    }
