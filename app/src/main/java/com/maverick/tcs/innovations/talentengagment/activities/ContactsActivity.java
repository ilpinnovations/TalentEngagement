...
public class ContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Key Contacts");
        }
        TextView textView = (TextView) findViewById(R.id.textView4);
        textView.setText(Html.fromHtml("Please contact " +
                "<a href=\" mailto:someone@example.com\" >uk.helpdesk@tcs.com</a> " + " for any reference/bonafide letters for: "));
        ...
        DBHelper dbHelper = new DBHelper(ContactsActivity.this);
